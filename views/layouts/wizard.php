...
<head>
    ...
    <!-- Critical CSS inline - landing v2 palette + anti-FOUC -->
    <style>
    ...
    <!-- Tailwind production - dla wizard steps -->
    ...
    <!-- Landing v2 system - tokeny, komponenty, motywy. Po Tailwindzie = wygrywa specificity. -->
    <link rel="stylesheet" href="<?= e(asset('assets/css/landing.css')) ?>">
    <link rel="stylesheet" href="<?= e(asset('assets/css/app.css')) ?>">
    <!-- Overlay - mapowanie Tailwind classes uzywanych w wizard steps na landing tokeny -->
...
<body>
        ...
        <div class="wrap nav-inner">
            ...
            <nav class="nav-links">
                <span style="color:var(--fg-3);font-size:14px;font-weight:600;display:inline-flex;align-items:center;gap:6px">
                    <span class="iconify" data-icon="ph:clipboard-text-bold"></span> Ankieta uczestnika
                </span>
            </nav>
            <div class="nav-cta">
    ...
    <!-- Landing v2 interactions (theme toggle przede wszystkim) -->
    <script src="<?= e(asset('assets/js/landing.js')) ?>" defer></script>

    <!-- Sync starsza klasa .dark <-> data-theme - landing.js manipuluje data-theme, wizard.js spodziewa sie .dark -->
    <script>
    (function () {
