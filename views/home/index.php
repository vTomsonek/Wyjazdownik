...
<section class="relative overflow-hidden">
    ...
    <div class="mx-auto max-w-7xl 3xl:max-w-[1600px] px-4 sm:px-6 lg:px-8 pt-10 pb-20 md:pt-16 md:pb-28 3xl:pt-24 3xl:pb-36">
        <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div class="flex flex-col gap-6 max-w-xl 3xl:max-w-2xl" data-animate>
                <span class="inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs sm:text-sm font-medium bg-primary/10 text-primary self-start">
                ...
                <div class="flex flex-wrap gap-3 mt-2">
                    <a href="<?= e(url('/admin/login')) ?>" class="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-primary text-white font-semibold text-base md:text-lg shadow-pop hover:bg-primary-dark hover:scale-105 transition">
                        Zaloguj się
            ...
            <div class="relative max-w-md 3xl:max-w-xl mx-auto lg:mx-0 w-full animate-float-slow" data-animate data-animate-delay="2">
