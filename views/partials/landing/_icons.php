<?php
/**
 * Lucide line-icon paths (ISC) - inlined.
 * Usage: landing_icon('compass', 18);
 * Stroke style: width 2, round caps/joins, currentColor.
 */

if (!function_exists('landing_icon')) {
    function landing_icon(string $name, int $size = 24, float $sw = 2.0): string
    {
        static $I = [
